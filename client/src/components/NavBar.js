	...
	<div>
		<nav className="navbar navbar-expand-lg navbar-light shadow justify-content-center" style={{background: "#eeeeee"}}>
			<div className="container">
				<a className="navbar-brand h1" href="/closet"><img src="https://cdn-icons.flaticon.com/png/512/3959/premium/3959060.png?token=exp=1637183899~hmac=ad944934feb2fb770d15419cb102b684" width="50" height="50" class="d-inline-block" alt="my closet logo"/>My closet</a>
